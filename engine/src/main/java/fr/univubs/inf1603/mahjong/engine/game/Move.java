...
public class Move implements Persistable,Serializable, Cloneable {
    ...
    private final HashMap<Integer, Boolean> publicyVisible;
 ...
 zone de jeu dans laquelle la tuile va être ajoutée
     * @param publicyVisible Une map qui contient la visibilité de la ou des 
     ...
     */
    public Move(Wind wind, int priority, HashMap<Integer, TileZoneIdentifier> path, HashMap<Integer, Boolean> publicyVisible, UUID uuid) throws MoveException {
        this.wind = wind;
        ...
        if (publicyVisible==null){
            throw new MoveException("The publiclyVisible can not be null");
        }
        this.publicyVisible = publicyVisible;

        this.uuid = uuid;
    }

    public Move(Wind wind, int priority, HashMap<Integer, TileZoneIdentifier> path, HashMap<Integer, Boolean> publicyVisible) throws MoveException {
        this(wind, priority, path, publicyVisible, UUID.randomUUID());
    }
     ...
     *
     * @return publicyVisible
     */
    public HashMap<Integer, Boolean> getPublicyVisible() {
        return this.publicyVisible;
    }
